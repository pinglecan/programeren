...
print(f'wat is de uitslag van wedstrijd 1 {land_2} vs {land_3}')
...
doelsaldo_land3 += w2_doel_punten_land_3 - w2_doel_punten_land_2
...
{land_3}: punten:   {punten_land_3}  doelsaldo:  {doelsaldo_land3}
''')
print(f'wat is de uitslag van wedstrijd 1 {land_3} vs {land_1}')
w3_doel_punten_land_3 = int(input(f'hoeveel goals heeft {land_3} geschoord? '))
w3_doel_punten_land_1 = int(input(f'hoeveel goals heeft {land_1} geschoord? '))

if w3_doel_punten_land_1 > w3_doel_punten_land_3:
    winnaar_3 = land_1
    punten_land_1 += 3
    punten_land_3 += 0
else:
...
doelsaldo_land1 += w3_doel_punten_land_1 - w2_doel_punten_land_3
doelsaldo_land3 += w3_doel_punten_land_3 - w3_doel_punten_land_1

print(f'''
Wedstrijd {land_3} - {land_1} eindigde in {w3_doel_punten_land_3} - {w3_doel_punten_land_1} 
{land_1}: punten:   {punten_land_1}  doelsaldo:  {doelsaldo_land1}
{land_2}: punten:   {punten_land_2}  doelsaldo:  {doelsaldo_land2}
{land_3}: punten:   {punten_land_3}  doelsaldo:  {doelsaldo_land3}
''')
...
2         |{land_2} |{land_3}|  {w2_doel_punten_land_2}            |   {w2_doel_punten_land_3}     |          {winnaar_2}
3         |{land_3} |{land_1}|   {w3_doel_punten_land_1}           |   {w3_doel_punten_land_3}     |          {winnaar_3}
''')